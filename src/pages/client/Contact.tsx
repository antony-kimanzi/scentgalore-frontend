      ...
      {isMobile ? (
        <div className="contact-mobile">
          ...
          <p>
            ...
            exploring wholesale options, our team of perfume enthusiasts is
            ready to assist.
          </p>
          <div className="reach-us-mobile">
          ...
          <div className="message-us-mobile">
            ...
            <span className="note-mobile">
              Don't hesitate to get in touch. We're here to help you have the
