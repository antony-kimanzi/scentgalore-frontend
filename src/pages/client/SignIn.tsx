...
export default function SignIn() {
  ...
  const { isScriptLoaded, renderGoogleButton } = useGoogleLogin({
    ...
    onSuccess: (userData) => {
      ...
      // Optional: Do something after successful sign in
    },
    onError: (error) => {
  ...
  return (
    <div>
      {isMobile ? (
        <div className="signin-page-mobile">
          <div className="signin-container-mobile">
            {error && <span className="error-message-mobile">{error}</span>}
            <Link to={"/"}>
              <img
            ...
            <h1 className="signin-title-mobile">Sign In</h1>
            <p className="signin-text-mobile">Welcome back!</p>
            <form
              className="signin-form-mobile"
              onSubmit={handleLoginWithEmail}
            >
              <label className="signin-label-mobile">Email</label>
              <input
                type="email"
                placeholder="Email"
                ...
                required
              />
              <label className="signin-label-mobile">Password</label>
              ...
              {!isLoading && (
                <button type="submit" className="signin-button-mobile">
                  Sign in with email
                </button>
              )}
            </form>
            {isLoading ? (
              ...
              <>
                <div className="google-signin-mobile">
                  <p>or sign in with</p>
          ...
          <div className="signin-footer-text-mobile">
        ...
        <div className="signin-page">
          <div className="signin-container">
            ...
            <form className="signin-form" onSubmit={handleLoginWithEmail}>
